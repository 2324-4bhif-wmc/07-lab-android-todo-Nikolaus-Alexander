...
public class VehicleService {
    ...
    VehicleService(RestApiClientBuilder builder, ModelStore store) {
        ...
        imageClient = builder.build(ImageClient.class, JSON_PLACEHOLDER_BASE_URL);
        this.store = store;
    }
    ...
    public void getImage(String brand, String model, String year) {
        CompletableFuture
                .runAsync(() -> imageClient.image(brand, model, year)) // Correctly supplying the parameters in a lambda
                .exceptionally((e) -> {
                    Log.e(TAG, "Error loading Vehicles", e);
                    return null;
                });
